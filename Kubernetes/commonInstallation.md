...
```bash
kubectl apply -f metrics-serviceaccount.yaml
...
```bash
docker build -t jibrandev/frontend:latest .
docker push -t jibrandev/frontend:latest .
docker build -t jibrandev/backend:latest .
docker push -t jibrandev/backend:latest .
